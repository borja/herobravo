...
def estados
  [
    ...
    },
    {
      id:     3,
      nombre: 'dormido',
      efecto: 'Aturdido (mientras dure el efecto) + Dormido.
               Despertará con : 6+ ó al ser golpeado.'
    },
    {
      id:     4,
      nombre: 'silenciado',
    ...
    },
    {
      id:     7,
      nombre: 'moribundo',
      efecto: '-1PC al realizar una acción.
               Los moribundos tumbados doblan sus turnos de agonía.
               Excepciones: Girar y el paso gratuito de movimiento.'
    },
    {
      id:     8,
      nombre: 'paralizado',
