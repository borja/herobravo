...
def enchants
  [
    ...
    { :id           => 22,
      :name         => "de basalto",
      :descripcion  => "+4 vs peste; 1 PS al matar; 1PM al recibir 1 herida de fuego.",
      :tipo         => "sombra",
    },
    { :id           => 23,
      :name         => "de fresno",
    ...
    { :id           => 79,
      ...
      :descripcion  => "5 cargas/reto<br>[+1 al matar no-muertos]<br>(1): +1 Ataque<br>(2): +2 PC<br>(1): Repetir una TS.",
      :tipo         => "sagrado",
    },
    { :id           => 80,
