...
def tarot cardinal
  [
    ...
    { 'La Sacerdotisa' => [
        ...
        'Si tienes los mismos PC que un aliado femenino, 
         ambos recuperáis todos.',
    ...
    { 'La Emperatriz' => [
        ...
        'Un rayo de energía tenebrosa fulmina con 3DC
         a la 3ª miniatura más cercana.',
        'El aliado de mayor nivel y tú, robáis 1 PC al de menor nivel.
         Si muere, +1px'
      ][cardinal] },
    { 'El Emperador' => [
        'Gira 90º todas las miniaturas, obligatoriamente.',
        'Todo el mundo se arrodilla salvo tú.
         (Se consideran tumbados en combate)',
        'Si eres el personaje con más PC, todos pierden 1PC. Si no, +3 PC.',
        'Todos los aliados te dan 5 piezas de oro.
         Luego deben olvidar el asunto.'
      ][cardinal] },
    { 'El Hierofante' => [
        'Todas las miniaturas sufren 1D-fuego de fuerza 2. Luego ganan 2PC.',
        'El jugador de tu derecha ejecuta una plegaria (tenebro).
         (Puede dañar aliados)',
        'Tu arma está bendita por Khorne. Desangra y roba vida. (Duración: E)',
        'Si el jugador de tu izquierda sabe hechizar, recupera 1.
         Si no, queda maldito.'
      ][cardinal] },
    { 'El Enamorado' => [
        '2 jugadores aleatorios igualan sus puntos de mente a 1d6-1.',
        '2 jugadores aleatorios quedan enamorados.
         (Según las reglas del juego)',
        '2 jugadores aleatorios están malditos por amor.
         (daño físico = -1PM del otro)',
        'Elige a un jugador/a.
         Su personaje recibirá el próximo daño que te inflijan.', 
      ][cardinal] },
    { 'El Carro' => [
        'Teletranspórtate a 1 casilla a tu elección.
         Después, el MB te desplazará 2 a pie.',
        'Cambia tu posición por la de un aliado.
         Si es de menor nivel, róbale 1PM.',
        'Tu personaje se teletransporta a la casilla
         contigua a la escalera de salida.',
        'Todos los que no estén en un pasillo
         sufren un ataque igual a su defensa.'
      ][cardinal] },
    { 'La Justicia' => [
        'Salvo que haya tantos héroes como villanos,
         el bando en desventaja paga 4PC.',
        'Bendice a la miniatura con más enemigos adyacentes
         con +4 potencia defensa.',
        'Si hay un personaje muriéndose, dale 2PC.
         Si esto te mata, quítale 3PM.',
        'Todo el que haya combatido este turno, pierde el siguiente.'
      ][cardinal] },
    { 'El Ermitaño' => [
        'Si estás solo en la sala, recuperas una habilidad única.',
        'Si alguna miniatura está sola en una sala,
         sufre 3 fuegos de Ira (tenebro).',
        'Todos los que no estén solos, recuperan 1PM.',
        'Todos los que no estén solos, te donan 1PC.
         Si sobra, recupera 1 magia.'
      ][cardinal] },
    { 'La Rueda de la Fortuna'  => [
        'Un jugador aleatorio está en gloria del héroe este turno
         y al siguiente -2PC.',
        'Un jugador aleatorio duplica el oro ganado por tesoros este reto
         y -1px.',
    ...
    { 'La Fuerza' => [
        'Un aliado aleatorio obtiene +1 fuerza. (Duración: E)
         Si mata, ganas +1PM.',
        'La miniatura más lejana sufre un impacto de 4DC de fuerza
         igual a tus PC.',
        'Una puerta a elección del MB se abre. Otra a tu elección se cierra.',
        'Hasta finalizar el reto podrás llevar un arma a 2 manos,
         en tu mano torpe.'
      ][cardinal] },
    { 'El Colgado' => [
        'Un jugador aleatorio es colgado bocabajo por una fuerza inexplicable.',
        'En cualquier momento de la partida,
         puedes caminar por el techo 1 turno.',
    ...
    { 'La Muerte' => [
        ...
        'Un calambre mata al familiar del jugador de tu izquierda.
         Si no te ríes, -1px.',
        'Todos los aliados perdéis 1d6 PC salvo que mueran más de 1.',
        'Señala con el dedo una miniatura viva (obligatoriamente)
         y quítala 1d6 PC.', 
      ][cardinal] },
    { 'La Templanza' => [
    ...
    { 'El Diablo' => [
        ...
        'El próximo vástago que nazca en el grupo será tiefling,
         si pagas un hechizo.'
      ][cardinal] },
    { 'La Torre' => [
    ...
    { 'La Luna' => [
        'Los elfos perderán su próximo turno
         y recuperan todos sus PC bailando.',
        'Cuando salga el Sol, sufre una maldición.
         Si ya salió, recupera 1 hechizo.',
    ...
    { 'El Sol' => [
        ...
        'El próximo hechizo de fuego ejecutado por cualquiera,
         será +1 maestría.',
        'Encuentras un disco de oro por valor de 1d6x tu nivel piezas de oro.',
        'Te quedas mirando al sol.
         Pierdes tu próximo turno, 1PC y estás cegado.'
      ][cardinal] },
    { 'El Juicio' => [
        'Sufre una herida igual al último daño que causaste.',
        'Un esqueleto entra a luchar a tu servicio.',
        'Ejecutas ipso-facto sobre 2 jugadores aleatorios a tu elección,
        2 hechizos.',
        'Un objetivo secundario queda imposibilitado.
        Si estaba hecho, gana 3PM.',
      ][cardinal] },
    { 'El Mundo' => [
        'Coloca 3 muros a tu elección. El MB coloca 3 fosos a su elección.',
        'El MB mueve a un jugador a tu elección a una sala ya revelada,
        a su elección.',
        'El MB mueve la casilla de la salida a una sala ya revelada,
        a su elección.',
    ...
    { 'El Loco' => [
        ...
        'Si algún aliado está loco, pierde todos sus PC
         y tú ganas 1px si te ríes.'
      ][cardinal]
    }
   ][rand(22)]
end
