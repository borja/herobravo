...
def joyas
  [
    ...
    Joya.new(id: 2, name: 'multicolor', fits: {
      hacha:    'Hacha doble (4 calaveras):
                    magia elemental aleatoria potencia:nivel',
    ...
    Joya.new(id: 6, name: 'antimagia', fits: {
      ...
      hombros:  '+1 galardón al matar en conjunto.
                 Activa, 3G: Todos odian a la víctima.
                 Pasiva (5G): En conjunto, todos cobran la pieza.'
    }),
    ...
    Joya.new(id: 9,  name: 'de la perfeccion', fits: {
      ...
      hombros:  '+1 galardón al obtener un galardón.
                 Pasiva (5G): Puedes acumular 6 galardones
                 y apilar dos efectos activos simultáneamente.',
      muñecas:  '+1 opresión al obtener opresión.
                 Pasiva (5G): Puedes acumular 6 p. de opresión
                 y apilar dos efectos activos simultáneamente.'
    }),
    ...
    Joya.new(id: 14, name: 'del verano', fits: {
      bastón:   'permite usar 3 magias del verano. Si se usa 1,
                 se desactivan las demás, salvo que sea gratuita)'
    }),
    Joya.new(id: 15, name: 'del invierno', fits: {
      bastón:   'permite usar 3 magias del invierno. Si se usa 1,
                 se desactivan las demás, salvo que sea gratuita)'
    }),
    Joya.new(id: 16, name: 'del otoño', fits: {
      bastón:   'permite usar 3 magias del otoño. Si se usa 1,
                 se desactivan las demás, salvo que sea gratuita)'
    }),
    Joya.new(id: 17, name: 'de la primavera', fits: {
      bastón:   'permite usar 3 magias de la primavera. Si se usa 1,
                 se desactivan las demás, salvo que sea gratuita)'
    }),
    ...
    Joya.new(id: 20, name: 'del Trueno', fits: {
      muñecas:  '+1 opresión al no dañar con un hechizo de aire.
                 Activa, 3o.: Lanzas un genio durante la fase de instintos.
                 Pasiva (5o.): +1 para recuperar el hechizo: genio'
    })
  ]
end
